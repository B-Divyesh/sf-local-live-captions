...
function footer(): string {
  return `<footer><div><strong>Local Live Captions</strong><p>Caption Linux calls and recordings on your device.</p></div><div class="footer-links"><a class="nav-link" href="/privacy">Privacy</a><a class="nav-link" href="/terms">Terms</a><a href="https://hello-factory.sociobot.in" rel="external">Built by Param Factory <span class="sr-only">(external)</span></a></div><p class="build">v0.1.0 · build 2026.08.28<br>Generated artwork disclosed in the <a href="https://github.com/B-Divyesh/sf-local-live-captions/blob/main/.factory/design.md" rel="external">design notes <span class="sr-only">(external)</span></a>.</p></footer>`;
}
...
function landing(): string {
  return shell(`<main id="main" tabindex="-1">
    <section class="hero">
      <div class="hero-copy"><p class="eyebrow">A private listening aid for Linux</p><h1 tabindex="-1">Caption any Linux audio locally</h1><p class="dek">For deaf and hard-of-hearing students when lectures, calls, or recordings have no captions.</p>
        <div class="hero-action"><a class="button primary nav-link" href="/demo">Try it with sample data <span aria-hidden="true">→</span></a><span>Opens a private sample. Nothing is saved.</span></div>
        <ul class="facts"><li><strong>Private</strong><span>Audio stays on your device.</span></li><li><strong>Offline</strong><span>Works after the model download.</span></li><li><strong>Fair</strong><span>English is free. Plus costs $24 once.</span></li></ul>
      </div>
      <figure class="hero-art"><picture><source media="(max-width: 720px)" srcset="/assets/listening-room-720.webp"><img src="/assets/listening-room-1120.webp" width="1120" height="747" alt="Paper sound waves fold into caption ribbons above a laptop in an empty lecture room." fetchpriority="high" decoding="async"></picture><figcaption>Speech becomes text without leaving the room.</figcaption></figure>
    </section>
    <section class="product-preview" aria-labelledby="preview-title"><div class="section-mark">01 / THE OVERLAY</div><div><h2 id="preview-title">Read the room, not another window</h2><p>Keep the resizable overlay above your lecture or call. Adjust the words without stopping captions.</p></div>${preview()}</section>
    <section id="how" class="steps" aria-labelledby="how-title"><div class="section-mark">02 / HOW IT WORKS</div><h2 id="how-title">Start captions in three clear steps</h2>
      <ol><li><span>1</span><div><h3>Choose the audio source</h3><p>Select your speakers or a PipeWire monitor. The app checks the source before capture.</p></div></li><li><span>2</span><div><h3>Download a speech model</h3><p>Choose English or German once. The model stays on this computer.</p></div></li><li><span>3</span><div><h3>Ask, then start</h3><p>Confirm that everyone agreed to captions. Stop at any time.</p></div></li></ol>
    ...
    <section class="limits" aria-labelledby="limits-title"><div class="section-mark">03 / CLEAR BOUNDARIES</div><div><h2 id="limits-title">Captions, without a meeting bot</h2><p>The app does not join calls, name speakers, or save audio. It keeps transcript text only while the session is open.</p></div><ul><li>No account</li><li>No cloud recording</li><li>No hidden capture</li><li>No perfect accuracy promise</li></ul></section>
    <section id="price" class="price" aria-labelledby="price-title"><div class="section-mark">04 / ONE-TIME LICENSE</div><div class="price-copy"><p class="kicker">Local Live Captions Plus</p><h2 id="price-title">Add German and larger models</h2><p>English captions, size controls, and transcript export stay free. Plus adds German and larger English models.</p><p class="price-number"><strong>$24</strong> once</p><a class="button primary" href="${API}/checkout">Buy Plus <span aria-hidden="true">→</span></a><p class="fine">Checkout and refunds are handled by Sociobot, the merchant of record.</p></div>
      <form id="license-form" class="license-form"><h3>Already bought Plus?</h3><label for="license">License token</label><input id="license" name="license" autocomplete="off" spellcheck="false"><button class="button secondary" type="submit">Verify license</button><p id="license-result" role="status"></p></form>
    </section>
    <section class="download" aria-labelledby="download-title"><div><p class="eyebrow">Built first for Linux</p><h2 id="download-title">Download the desktop app</h2><p>Choose an AppImage or Debian package. macOS and Windows builds are also published.</p><p class="sign-note">Current builds are unsigned. Your system may ask you to confirm the download.</p></div><div id="download-slot" class="download-slot" aria-live="polite"><span class="loading-line">Checking the latest release…</span></div></section>
  </main>`);
}
...
const legal = {
  "/privacy": { title: "Privacy — Local Live Captions", h1: "Your audio stays with you", intro: "Local Live Captions is designed to process speech on your computer.", body: `<h2>What the app handles</h2><p>The desktop app reads audio from the source you choose. It processes that audio in memory with a downloaded speech model. It does not save raw audio.</p><h2>What is stored</h2><p>Settings, downloaded model files, and an optional license token stay on your computer. Transcript text stays in memory until you export it or close the session.</p><h2>Network access</h2><p>The app uses the network when you download a model or verify a Plus license. Model downloads come from Hugging Face. License checks go to Sociobot. Audio and transcript text are never sent with either request.</p><h2>Website data</h2><p>This site has no advertising trackers. The demo uses a separate <code>demo:</code> browser storage namespace and clears it when you leave.</p><h2>Your choices</h2><p>You can delete models and remove your license from the app settings. Contact <a href="mailto:privacy@sociobot.in">privacy@sociobot.in</a> with privacy questions.</p><p><em>Effective 28 August 2026.</em></p>` },
  "/terms": { title: "Terms — Local Live Captions", h1: "Use captions with consent", intro: "These terms cover the Local Live Captions app and website.", body: `<h2>Permission to caption</h2><p>Tell people when capture starts. Get any consent required by your school, workplace, or local law.</p><h2>Accuracy</h2><p>Automatic captions can miss or change words. Do not use them as the only record for medical, legal, safety, or assessment decisions.</p><h2>License</h2><p>The free app features remain available without payment. A $24 one-time Plus license adds German and larger model choices for one person. Sociobot and Dodo handle payment as merchant of record. A refund revokes the related license.</p><h2>Software</h2><p>The app is provided under the MIT License, without warranty. You are responsible for choosing and following each downloaded model license.</p><h2>Contact</h2><p>Email <a href="mailto:support@sociobot.in">support@sociobot.in</a> for support or terms questions.</p><p><em>Effective 28 August 2026.</em></p>` }
} as const;
...
function notFound(): string {
  return shell(`<main id="main" class="not-found" tabindex="-1"><div class="lost-ribbon" aria-hidden="true"></div><p class="eyebrow">404 · Lost caption</p><h1 tabindex="-1">This page went quiet</h1><p>The address does not point to a page here.</p><a class="button primary nav-link" href="/">Return home</a></main>`);
}
...
function wireShared(): void {
  ...
  document.querySelectorAll<HTMLInputElement>("[data-caption-size]").forEach((input) => input.addEventListener("input", () => {
    ...
    if (location.pathname === "/demo") sessionStorage.setItem("demo:caption-size", input.value);
  }));
  document.querySelectorAll<HTMLElement>("[data-action='toggle-captions']").forEach((button) => button.addEventListener("click", () => {
    ...
    button.textContent = isPaused ? (location.pathname === "/demo" ? "Pause captions" : "Stop captions") : "Resume captions";
    const state = button.closest(".caption-stage")!.querySelector<HTMLElement>(".capture-state")!;
    state.innerHTML = isPaused ? `<i></i>${location.pathname === "/demo" ? "Capturing sample" : "Capturing"}` : "Stopped";
  }));
...
function setupLicense(): void {
  ...
  form?.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      if (verdict.valid) { localStorage.setItem(LICENSE_KEY, token); localStorage.setItem(`${LICENSE_KEY}:verified`, String(Date.now())); result!.textContent = "Plus is active on this browser."; }
...
function render(): void {
  ...
  const titles: Record<Route, string> = { "/": "Local Live Captions — Caption Linux audio locally", "/demo": "Demo — Local Live Captions", "/privacy": "Privacy — Local Live Captions", "/terms": "Terms — Local Live Captions", "/404": "Page not found — Local Live Captions" };
...
async function renderDesktop(): Promise<void> {
  ...
  const wireSetup = async () => {
    ...
    try { const devices = await invoke<string[]>("list_audio_devices"); select.innerHTML = devices.length ? devices.map((name) => `<option>${escapeHtml(name)}</option>`).join("") : `<option value="">No audio source found</option>`; }
