...
function landing(): string {
  return shell(`<main id="main" tabindex="-1">
    ...
    <section id="price" class="price" aria-labelledby="price-title"><div class="section-mark" aria-hidden="true"></div><div class="price-copy"><p class="kicker">Local Live Captions supporter license</p><h2 id="price-title">Optional $24 supporter license</h2><p>English and German speech models, size controls, and transcript export stay free. A supporter license is optional; it does not unlock caption features.</p><p class="price-number"><strong>$24</strong> once</p><a class="button primary" href="${API}/checkout" target="_blank" rel="noopener external">Buy supporter license <span class="sr-only">(external checkout)</span><span aria-hidden="true">→</span></a><p class="fine">The checkout link opens through Sociobot. If it does not open, try again later. Captions stay free.</p></div>
...
const legal = {
  ...
  "/terms": { title: "Terms — Local Live Captions", h1: "Use captions with consent", intro: "These terms cover the Local Live Captions app and website.", body: `<h2>Permission to caption</h2><p>Tell people when capture starts. Get any consent required by your school, workplace, or local law.</p><h2>Accuracy</h2><p>Automatic captions can miss or change words. Do not use them as the only record for medical, legal, safety, or assessment decisions.</p><h2>Supporter license</h2><p>All caption features remain available without payment. A $24 one-time supporter license is optional. The checkout link opens through Sociobot. If it does not open, try again later.</p><h2>Software</h2><p>The app is provided under the MIT License, without warranty. You are responsible for choosing and following each downloaded model license.</p><h2>Contact</h2><p>Email <a href="mailto:support@sociobot.in">support@sociobot.in</a> for support or terms questions.</p><p><em>Effective 29 August 2026.</em></p>` }
} as const;
